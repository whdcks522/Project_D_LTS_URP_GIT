namespace Gpm.Ui
{
    ...
    public class InfiniteScroll : MonoBehaviour
    {
        ...
        protected List<int>                     itemShowDataIndex       = new List<int>();
        ...
        {
            for (int index = 0; index < itemShowDataIndex.Count; index++)
            {
        ...
        private void UpdateShowItem(bool forceUpdateData = false)
        {
            ...
            for (int dataIndex = firstDataIndex; dataIndex < firstDataIndex + madeItemNumber; ++dataIndex)
            {
                ...
                else
                {
                    ...
                    size += itemSizeList[dataIndex] + space;
                }
            }

            for(int index = 0;index < items.Count; index++)
            {
                if ( index >= itemShowDataIndex.Count ||
                    itemShowDataIndex[index] == -1)
                {
